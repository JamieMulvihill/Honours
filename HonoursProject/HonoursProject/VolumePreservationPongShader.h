...
class VolumePreservationPongShader : public BaseShader
{
private:
...
public:
	VolumePreservationPongShader(ID3D11Device* device, HWND hwnd, int w, int h);
	~VolumePreservationPongShader();
